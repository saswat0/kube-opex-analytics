...
{{ include "kube-opex-analytics.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kube-opex-analytics.selectorLabels" -}}
...
*/}}
{{- define "kube-opex-analytics.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kube-opex-analytics.fullname" .) .Values.serviceAccount.name }}
{{- else }}
